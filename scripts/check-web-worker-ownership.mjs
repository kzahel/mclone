...
const moduleRegistry = {
  ...
  "mclone-render-compiler-shared.ts": {
    ...
    responsibilities: [
      "render Worker construction",
      "external SAB doorbell mechanics",
      "registered main-side render-broker debt",
    ],
  },
...
const domainDebt = [
  ...
  },
  {
    ...
    maximum: 1,
    destination: "browser-specific Rust render compiler broker",
  },
  {
