...
if (receipt.id !== "mallard-ecology" || receipt.revision !== "3") {
...
if (!/5 entities, 5 actors, 5 drawn actors/.test(output)) {
  throw new Error("mallard ecology capture did not draw all five persisted actors");
}
