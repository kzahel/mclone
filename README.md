...
- **Future native targets:** flat Android and Android XR / Quest standalone are expected later; keep shared runtime and renderer contracts host-neutral now, but do not scaffold Android/OpenXR until a focused tactical calls for it.
