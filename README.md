...
- **Next native platform target:** flat Android `NativeActivity` APK, non-XR, tracked by [`docs/tactical/074-flat-android-build-smoke.md`](docs/tactical/074-flat-android-build-smoke.md).
