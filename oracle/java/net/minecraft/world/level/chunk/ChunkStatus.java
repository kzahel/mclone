...
public class ChunkStatus {
   ...
   private static ChunkStatus registerSimple(
      String var0, ChunkStatus var1, int var2, EnumSet<Heightmap.Types> var3, ChunkStatus.ChunkType var4, ChunkStatus.SimpleGenerationTask var5
   ) {
      return register(var0, var1, var2, var3, var4, var5);
   }

   private static ChunkStatus register(
      String var0, ChunkStatus var1, int var2, EnumSet<Heightmap.Types> var3, ChunkStatus.ChunkType var4, ChunkStatus.GenerationTask var5
   ) {
   ...
   public CompletableFuture<Either<ChunkAccess, ChunkHolder.ChunkLoadingFailure>> generate(
      ...
      McloneSchedulerTraceRecorder.recordDependencyReady(this, var8, var7);
      McloneSchedulerTraceRecorder.recordTaskStart(this, var8, var7);
