...
mod tests {
    ...
    #[derive(Clone, Copy, Debug)]
    struct PaletteTintGroup {
        tint_group: &'static str,
        biome_ids: &'static [i32],
        grass: u32,
        foliage: u32,
        water: u32,
    }

    const PALETTE_TINT_GROUPS: &[PaletteTintGroup] = &[
        PaletteTintGroup {
            tint_group: "ocean-default",
            biome_ids: &[0, 24],
            grass: 0x8e_b9_71,
            foliage: 0x71_a7_4d,
        ...
        PaletteTintGroup {
            tint_group: "mountains",
            biome_ids: &[3, 20, 25, 34, 131, 162],
            grass: 0x8a_b6_89,
            foliage: 0x6f_a0_78,
            water: DEFAULT_WATER_COLOR,
        },
        ...
        PaletteTintGroup {
            tint_group: "jungle",
            biome_ids: &[21, 22, 149, 168, 169],
            grass: 0x59_c9_3c,
            foliage: 0x30_bb_0b,
            water: DEFAULT_WATER_COLOR,
        },
        PaletteTintGroup {
            tint_group: "jungle-edge",
            biome_ids: &[23, 151],
            grass: 0x59_c9_3c,
            foliage: 0x30_bb_0b,
            water: DEFAULT_WATER_COLOR,
        ...
        PaletteTintGroup {
            tint_group: "birch",
            biome_ids: &[27, 28, 155, 156],
            grass: 0x88_bb_67,
            foliage: 0x80_a7_55,
            water: DEFAULT_WATER_COLOR,
        },
        PaletteTintGroup {
            tint_group: "dark-forest",
            biome_ids: &[29, 157],
            grass: 0x50_7a_32,
            foliage: 0x59_9b_35,
            water: DEFAULT_WATER_COLOR,
        ...
        PaletteTintGroup {
            tint_group: "badlands",
            biome_ids: &[37, 38, 39, 165, 166, 167],
            grass: 0x90_81_4d,
            foliage: 0x9e_81_4d,
            water: DEFAULT_WATER_COLOR,
        },
    ...
    fn palette_matrix_tint_groups_match_java_visual_facts() {
        ...
        for group in PALETTE_TINT_GROUPS {
            for biome_id in group.biome_ids {
                assert_eq!(
                    block_tint(&catalog, TexturedBlockTint::Grass, 0, 64, 0, |_, _, _| {
                        *biome_id
                    }),
                    rgb8(group.grass),
                    "{} biome id {} grass tint",
                ...
                assert_eq!(
                    ...
                    rgb8(group.foliage),
                    "{} biome id {} foliage tint",
                    group.tint_group,
                    biome_id
                );
                assert_eq!(
                    blended_liquid_color(TexturedFluidKind::Water, 0, 64, 0, 1.0, |_, _, _| {
                        *biome_id
                    }),
                    rgb8_alpha(group.water, 0.72),
                    "{} biome id {} water tint",
                    group.tint_group,
                    biome_id
                );
