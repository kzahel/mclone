...
pub use figure::{
    ...
    FIRST_PARTY_SEMANTIC_PROP_FIGURE_IDS, FigureAlphaCoverage, FigureAlphaMode, FigureAsciiTexture,
    FigureAsset, FigureClip, FigureClipContact, FigureClipKey, FigureClipLocomotion,
    FigureClipRole, FigureClipTransform, FigureFace, FigureJoint, FigureMaterial, FigurePart,
    FigurePlaneSidedness, FigurePrimitive, MALLARD_DUCK_FIGURE_ID, MALLARD_DUCK_FIGURE_PATH,
    MALLARD_FEATHER_FIGURE_ID, MALLARD_FEATHER_FIGURE_PATH, MALLARD_NEST_FIGURE_ID,
    MALLARD_NEST_FIGURE_PATH, SemanticFigureId, UPRIGHT_BEAR_FIGURE_ID, UPRIGHT_BEAR_FIGURE_PATH,
