...
pub use figure::{
    ...
    DEER_FIGURE_ID, DEER_FIGURE_PATH, DEFAULT_PLAYER_FIGURE_ID, DEFAULT_PLAYER_FIGURE_PATH,
    ...
    FigureMaterial, FigurePart, FigurePlaneSidedness, FigurePrimitive, MALLARD_DUCK_FIGURE_ID,
    MALLARD_DUCK_FIGURE_PATH, MALLARD_FEATHER_FIGURE_ID, MALLARD_FEATHER_FIGURE_PATH,
    MALLARD_NEST_FIGURE_ID, MALLARD_NEST_FIGURE_PATH, SemanticFigureId, UPRIGHT_BEAR_FIGURE_ID,
    UPRIGHT_BEAR_FIGURE_PATH, chicken_figure_id, chicken_figure_path, cow_figure_id,
    cow_figure_path, deer_figure_id, deer_figure_path, default_player_figure_id,
    default_player_figure_path, first_party_actor_figure_path, load_figure_asset,
    mallard_duck_figure_id, mallard_duck_figure_path, mallard_feather_figure_id,
    mallard_feather_figure_path, mallard_nest_figure_id, mallard_nest_figure_path,
    semantic_figure_path, upright_bear_figure_id, upright_bear_figure_path,
};
pub use first_party::{
