...
pub use figure::{
    ...
    SHED_ANTLER_FIGURE_PATH, SLEEPING_MAT_FIGURE_ID, SLEEPING_MAT_FIGURE_PATH, SemanticFigureId,
    UPRIGHT_BEAR_FIGURE_ID, UPRIGHT_BEAR_FIGURE_PATH, VENISON_FIGURE_ID, VENISON_FIGURE_PATH,
    WHEAT_BUNDLE_FIGURE_ID, WHEAT_BUNDLE_FIGURE_PATH, WHEAT_SEEDS_ITEM_FIGURE_ID,
    WHEAT_SEEDS_ITEM_FIGURE_PATH, bee_figure_id, bee_figure_path, bee_hotel_figure_id,
    bee_hotel_figure_path, bee_hotel_item_figure_id, bee_hotel_item_figure_path,
    bee_nest_figure_id, bee_nest_figure_path, beeswax_figure_id, beeswax_figure_path,
    carrot_figure_id, carrot_figure_path, chicken_figure_id, chicken_figure_path, cow_figure_id,
    ...
    mallard_nest_figure_path, oak_fence_gate_item_figure_id, oak_fence_gate_item_figure_path,
    oak_fence_item_figure_id, oak_fence_item_figure_path, rabbit_burrow_figure_id,
    rabbit_burrow_figure_path, rabbit_figure_id, rabbit_figure_path, semantic_figure_path,
    shed_antler_figure_id, shed_antler_figure_path, sleeping_mat_figure_id,
