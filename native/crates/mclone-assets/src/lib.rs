...
pub use figure::{
    ...
    RABBIT_BURROW_FIGURE_PATH, RABBIT_FIGURE_ID, RABBIT_FIGURE_PATH, SHED_ANTLER_FIGURE_ID,
    SHED_ANTLER_FIGURE_PATH, SemanticFigureId, UPRIGHT_BEAR_FIGURE_ID, UPRIGHT_BEAR_FIGURE_PATH,
    VENISON_FIGURE_ID, VENISON_FIGURE_PATH, WHEAT_BUNDLE_FIGURE_ID, WHEAT_BUNDLE_FIGURE_PATH,
    WHEAT_SEEDS_ITEM_FIGURE_ID, WHEAT_SEEDS_ITEM_FIGURE_PATH, bee_figure_id, bee_figure_path,
    bee_hotel_figure_id, bee_hotel_figure_path, bee_hotel_item_figure_id,
    bee_hotel_item_figure_path, bee_nest_figure_id, bee_nest_figure_path, beeswax_figure_id,
    beeswax_figure_path, carrot_figure_id, carrot_figure_path, chicken_figure_id,
    chicken_figure_path, cow_figure_id, cow_figure_path, deer_bed_figure_id, deer_bed_figure_path,
    deer_figure_id, deer_figure_path, deer_hide_figure_id, deer_hide_figure_path,
    default_player_figure_id, default_player_figure_path, first_party_actor_figure_path,
    hunting_spear_figure_id, hunting_spear_figure_path, load_figure_asset, mallard_duck_figure_id,
    mallard_duck_figure_path, mallard_feather_figure_id, mallard_feather_figure_path,
    mallard_nest_figure_id, mallard_nest_figure_path, oak_fence_gate_item_figure_id,
    oak_fence_gate_item_figure_path, oak_fence_item_figure_id, oak_fence_item_figure_path,
    rabbit_burrow_figure_id, rabbit_burrow_figure_path, rabbit_figure_id, rabbit_figure_path,
