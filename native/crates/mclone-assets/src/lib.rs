...
pub use figure::{
    ...
    BEESWAX_FIGURE_ID, BEESWAX_FIGURE_PATH, CHICKEN_FIGURE_ID, CHICKEN_FIGURE_PATH, COW_FIGURE_ID,
    ...
    VENISON_FIGURE_ID, VENISON_FIGURE_PATH, bee_figure_id, bee_figure_path, bee_hotel_figure_id,
    ...
    upright_bear_figure_path, venison_figure_id, venison_figure_path,
};
pub use first_party::{
