...
pub use figure::{
    ActorFigureId, BEE_FIGURE_ID, BEE_FIGURE_PATH, BEE_HOTEL_FIGURE_ID, BEE_HOTEL_FIGURE_PATH,
    BEE_HOTEL_ITEM_FIGURE_ID, BEE_HOTEL_ITEM_FIGURE_PATH, BEE_NEST_FIGURE_ID, BEE_NEST_FIGURE_PATH,
    BEESWAX_FIGURE_ID, BEESWAX_FIGURE_PATH, CARROT_FIGURE_ID, CARROT_FIGURE_PATH,
    CHICKEN_FIGURE_ID, CHICKEN_FIGURE_PATH, COW_FIGURE_ID, COW_FIGURE_PATH, DEER_BED_FIGURE_ID,
    DEER_BED_FIGURE_PATH, DEER_FIGURE_ID, DEER_FIGURE_PATH, DEER_HIDE_FIGURE_ID,
    DEER_HIDE_FIGURE_PATH, DEFAULT_PLAYER_FIGURE_ID, DEFAULT_PLAYER_FIGURE_PATH,
    FIRST_PARTY_ACTOR_FIGURE_IDS, FIRST_PARTY_SEMANTIC_PROP_FIGURE_IDS, FigureAlphaCoverage,
    FigureAlphaMode, FigureAsciiTexture, FigureAsset, FigureClip, FigureClipContact, FigureClipKey,
    FigureClipLocomotion, FigureClipRole, FigureClipTransform, FigureFace, FigureJoint,
    FigureMaterial, FigurePart, FigurePlaneSidedness, FigurePrimitive, HUNTING_SPEAR_FIGURE_ID,
    HUNTING_SPEAR_FIGURE_PATH, MALLARD_DUCK_FIGURE_ID, MALLARD_DUCK_FIGURE_PATH,
    MALLARD_FEATHER_FIGURE_ID, MALLARD_FEATHER_FIGURE_PATH, MALLARD_NEST_FIGURE_ID,
    MALLARD_NEST_FIGURE_PATH, OAK_FENCE_GATE_ITEM_FIGURE_ID, OAK_FENCE_GATE_ITEM_FIGURE_PATH,
    OAK_FENCE_ITEM_FIGURE_ID, OAK_FENCE_ITEM_FIGURE_PATH, RABBIT_BURROW_FIGURE_ID,
    RABBIT_BURROW_FIGURE_PATH, RABBIT_FIGURE_ID, RABBIT_FIGURE_PATH, RED_SQUIRREL_FIGURE_ID,
    RED_SQUIRREL_FIGURE_PATH, SHED_ANTLER_FIGURE_ID, SHED_ANTLER_FIGURE_PATH,
    SLEEPING_MAT_FIGURE_ID, SLEEPING_MAT_FIGURE_PATH, SemanticFigureId, UPRIGHT_BEAR_FIGURE_ID,
    ...
    bee_figure_id, bee_figure_path, bee_hotel_figure_id, bee_hotel_figure_path,
    bee_hotel_item_figure_id, bee_hotel_item_figure_path, bee_nest_figure_id, bee_nest_figure_path,
    beeswax_figure_id, beeswax_figure_path, carrot_figure_id, carrot_figure_path,
    chicken_figure_id, chicken_figure_path, cow_figure_id, cow_figure_path, deer_bed_figure_id,
    deer_bed_figure_path, deer_figure_id, deer_figure_path, deer_hide_figure_id,
    deer_hide_figure_path, default_player_figure_id, default_player_figure_path,
    first_party_actor_figure_path, hunting_spear_figure_id, hunting_spear_figure_path,
    load_figure_asset, mallard_duck_figure_id, mallard_duck_figure_path, mallard_feather_figure_id,
    mallard_feather_figure_path, mallard_nest_figure_id, mallard_nest_figure_path,
    oak_fence_gate_item_figure_id, oak_fence_gate_item_figure_path, oak_fence_item_figure_id,
    oak_fence_item_figure_path, rabbit_burrow_figure_id, rabbit_burrow_figure_path,
    rabbit_figure_id, rabbit_figure_path, red_squirrel_figure_id, red_squirrel_figure_path,
    semantic_figure_path, shed_antler_figure_id, shed_antler_figure_path, sleeping_mat_figure_id,
    sleeping_mat_figure_path, upright_bear_figure_id, upright_bear_figure_path, venison_figure_id,
    venison_figure_path, wheat_bundle_figure_id, wheat_bundle_figure_path,
    wheat_seeds_item_figure_id, wheat_seeds_item_figure_path, wildlife_remains_figure_id,
    wildlife_remains_figure_path,
};
pub use first_party::{
