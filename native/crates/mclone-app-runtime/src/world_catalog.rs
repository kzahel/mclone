...
mod tests {
    ...
    fn procedural_generation_profile_metadata_is_stable_and_cycles_in_order() {
        ...
        assert_eq!(
            local_world_generation_profile_display_name(WorldGenerationProfile::McloneOverworldV2),
        ...
        assert_eq!(
            local_world_generation_profile_display_name(WorldGenerationProfile::alpha_v1(true)),
            "Alpha (Winter)"
        );
        assert_eq!(
        ...
        assert_eq!(
            next_local_world_generation_profile(WorldGenerationProfile::alpha_v1(false)),
            WorldGenerationProfile::alpha_v1(true)
        );
        assert_eq!(
