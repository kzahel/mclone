...
mod tests {
    ...
    fn worldgen_delta_session_reuses_resident_mirror_across_jobs() {
        ...
        let req2 =
            encode_worldgen_delta_request(ChunkJobId(2), seed, 7, false, &second_targets, &[])
                .unwrap();
        let decoded2 =
    ...
    fn worldgen_delta_session_rejects_generation_desync() {
        ...
        let req_bad =
            encode_worldgen_delta_request(ChunkJobId(2), seed, 2, false, &targets, &[]).unwrap();
        ...
        let req_premature =
            encode_worldgen_delta_request(ChunkJobId(3), seed, 1, false, &targets, &[]).unwrap();
