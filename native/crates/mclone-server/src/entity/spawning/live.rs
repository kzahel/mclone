...
/// Plans the Java-profile live passive-spawn subset.
///
/// Mclone Overworld intentionally does not call this path. Its ordinary
/// wildlife comes from the coordinate-pure first-realization planner.
    ...
    L: FnMut(BlockPos) -> Option<u8>,
{
    ...
    for chunk in sampled_eligible_chunks(eligible_chunks, random) {
