...
fn integrated_server_publishes_interested_chunks() {
    ...
    assert_eq!(
        ...
        ChunkSchedulerMetrics {
            ...
            player_promotion_oldest_active_age_ticks: 0,
            player_promotion_active_waiting_for_holder: 0,
            player_promotion_active_waiting_for_storage: 0,
            player_promotion_active_waiting_for_features: 0,
            player_promotion_active_waiting_for_light_prerequisite: 0,
            player_promotion_active_light_deferred: 0,
            player_promotion_active_light_demand_queued: 0,
            player_promotion_active_light_mailbox_owned: 0,
            player_promotion_active_light_publication_pending: 0,
            player_promotion_active_light_scheduled_without_token: 0,
            player_promotion_active_light_token_without_owner: 0,
            player_promotion_active_ready_awaiting_release: 0,
            ...
            light_restartable_contexts: 0,
            light_restartable_context_bytes: 0,
            light_deferred: 0,
            ...
            light_scheduled_without_token: 0,
            debug_light_admission_delay_ticks: 0,
            debug_light_admission_delayed_demands: 0,
