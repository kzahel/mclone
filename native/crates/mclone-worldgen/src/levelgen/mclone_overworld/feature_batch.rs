...
mod tests {
    ...
    fn feature_stage_places_the_profile_owned_vegetation_family() {
        ...
        assert_eq!(decoration_counts, [53, 2_913, 354, 193]);
        assert_eq!(hash, 12_963_872_145_853_843_350);
    }
    ...
    fn reviewed_landforms_pin_final_decorated_payloads() {
        ...
        assert_eq!(
            ...
            [
                ...
                ([0, 4, 0, 0], 10_109_977_573_594_455_766),
                ([0, 0, 0, 0], 12_860_203_473_588_958_519),
            ]
        );
    }
}
