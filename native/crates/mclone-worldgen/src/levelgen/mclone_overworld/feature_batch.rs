...
mod tests {
    ...
    fn feature_stage_places_the_profile_owned_vegetation_family() {
        ...
        assert_eq!(decoration_counts, [53, 3_020, 361, 204]);
        assert_eq!(hash, 5_710_010_850_979_914_490);
    }
    ...
    fn reviewed_landforms_pin_final_decorated_payloads() {
        ...
        assert_eq!(
            ...
            [
                ...
                ([0, 2, 0, 0], 14_755_702_441_895_597_413),
                ([0, 0, 0, 0], 6_620_905_785_342_849_164),
            ]
        );
    }
}
