...
mod tests {
    ...
    fn feature_stage_places_the_profile_owned_vegetation_family() {
        ...
        assert_eq!(
            decoration_counts,
            [111, 621, 247, 1_977, 367, 6, 20, 49, 67, 42]
        );
        assert_eq!(hash, 3_097_611_745_371_964_735);
    }
    ...
    fn reviewed_landforms_pin_final_decorated_payloads() {
        ...
        assert_eq!(
            receipts,
            [
                ([0, 0, 0, 0], 10_979_466_551_522_974_892),
                ([0, 0, 0, 0], 14_922_462_017_995_624_749),
                ([0, 1, 0, 0], 18_096_138_942_173_239_649),
            ]
        );
    }
}
