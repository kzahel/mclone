...
pub(super) fn sample_mclone_overworld_landform_with_sampler_and_stream_cache(
    seed: i64,
    topology: McloneOverworldSamplingTopology,
...
mod tests {
    ...
    fn selected_regions_contain_land_water_and_pin_seed_output() {
        ...
        assert_eq!(
            fingerprints,
            [
                (16_983_996_182_706_506_361, 540_454_697_130_909_605),
                (10_329_698_439_788_996_518, 3_995_179_115_581_767_979),
                (12_358_679_440_644_861_397, 14_722_381_067_837_031_305),
            ]
        );
    }
    ...
    fn selected_regions_exercise_and_pin_biome_and_surface_language() {
        ...
        assert_eq!(
            ...
            [
                (
                    [21_961, 1_419, 17_274, 6_224, 1_441, 9_613, 9, 7_595],
                    [
                        21_961, 812, 1_398, 43, 1_883, 31_555, 563, 9, 26, 511, 2_499, 4_276,
                    ],
                    6_068_905_429_826_639_592,
                ),
                (
                    [17_223, 782, 11_934, 10_447, 1_699, 20_073, 1_022, 2_356],
                    [
                        17_223, 418, 1_585, 114, 1_865, 29_344, 1_033, 999, 52, 308, 3_018, 9_577,
                    ],
                    10_493_926_565_877_659_007,
                ),
                (
                    [33_641, 2_588, 9_861, 5_533, 989, 4_225, 0, 8_699],
                    [
                        33_641, 1_550, 916, 73, 1_503, 23_988, 211, 0, 0, 739, 1_741, 1_174,
                    ],
                    9_479_556_214_786_506_904,
                ),
            ]
        );
    }
