...
pub use profile::{
    ...
    SMALL_ISLAND_SPAWN_SURFACE_Y, SMALL_ISLAND_SUPPORT_RADIUS, generate_flat_grass_chunk,
    generate_small_island_chunk, small_island_biome_id, small_island_surface_height,
};
