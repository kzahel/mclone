...
pub(crate) use placed::{
    apply_feature_table_to_region_timed, apply_feature_table_to_region_with_index_offset_timed,
...
pub(crate) use tables::{flower_patch, grass_patch, small_island_feature_table};
