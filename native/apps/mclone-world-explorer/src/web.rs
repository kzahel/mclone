...
struct WebExplorerReport {
    ...
    exact_handoff_topology: &'static str,
    procedural_coverage_generation: u64,
    procedural_painted_chunks: u32,
    exact_coverage_mask_bytes: u64,
    exact_connector_segments: u32,
    exact_connector_vertex_count: u32,
    exact_connector_bytes: u64,
    exact_transition_preparation_micros: u64,
    exact_transition_payload_bytes: u64,
...
fn explorer_report(
    ...
    WebExplorerReport {
        ...
        exact_handoff_topology: stats.exact_handoff_topology.label(),
        ...
        exact_connector_segments: stats.exact_connector_segments,
        exact_connector_vertex_count: stats.exact_connector_vertex_count,
        exact_connector_bytes: stats.exact_connector_bytes,
        exact_transition_preparation_micros: stats.exact_transition_preparation_micros,
        exact_transition_payload_bytes: stats.exact_transition_payload_bytes,
