...
use crate::cli::{
    Cli, FrameBudgetProbeMode, FrameBudgetProbeOptions, HeadlessScreenshotOptions,
    HeadlessScreenshotUi, MovementPerfOptions, SceneOptions, TimedemoOptions,
...
impl CachedTexturedRenderSections {
    ...
    fn contains_section(&self, key: RenderSectionKey) -> bool {
