    ...
    match Cli::parse(std::env::args().skip(1))? {
        ...
        Cli::HeadlessScreenshot { options } => {
            ...
            let terrain_view = report.terrain_view.map_or_else(
                ...
                |terrain| {
                    let frontier = terrain.frontier;
                    let candidates = frontier.candidates;
                    let format = frontier.format;
                    let frontier_format = serde_json::json!({
                        "paintedChunks": format.painted_chunks,
                        "canonicalChunkWidth": format.canonical_chunk_width,
                        "canonicalChunkHeight": format.canonical_chunk_height,
                        "liftedChunkWidth": format.lifted_chunk_width,
                        "liftedChunkHeight": format.lifted_chunk_height,
                        "boundaryWidthBlocks": format.boundary_width_blocks,
                        "boundaryHeightBlocks": format.boundary_height_blocks,
                        "transitionWidthTexels": format.transition_width_texels,
                        "transitionHeightTexels": format.transition_height_texels,
                        "maskValid": format.mask_valid,
                        "boundaryValid": format.boundary_valid,
                        "transitionValid": format.transition_valid,
                        "allValid": format.all_valid,
                        "canonicalPackingExpandsLocalExtent": format.canonical_packing_expands_local_extent,
                    });
                    let frontier_candidates = serde_json::json!({
                        "fullFinestTilesPerAxis": candidates.full_finest_tiles_per_axis,
                        "fullFinestLogicalTiles": candidates.full_finest_logical_tiles,
                        "fullFinestStagingTiles": candidates.full_finest_staging_tiles,
                        "fullFinestAddedBytes": candidates.full_finest_added_bytes,
                        "sparseDesiredFineTiles": candidates.sparse_desired_fine_tiles,
                        "sparseBaseResidentFineTiles": candidates.sparse_base_resident_fine_tiles,
                        "sparseAdditionalFineTiles": candidates.sparse_additional_fine_tiles,
                        "sparseAdmittedFineTiles": candidates.sparse_admitted_fine_tiles,
                        "sparseRejectedFineTiles": candidates.sparse_rejected_fine_tiles,
                        "sparseAdditionalBytes": candidates.sparse_additional_bytes,
                        "sparseOuterEdgeSegments": candidates.sparse_outer_edge_segments,
                        "sparseVertexUpperBound": candidates.sparse_vertex_upper_bound,
                        "resolutionAwareConnectorSegments": candidates.resolution_aware_connector_segments,
                        "resolutionAwareConnectorBytes": candidates.resolution_aware_connector_bytes,
                        "resolutionAwareConnectorVertices": candidates.resolution_aware_connector_vertices,
                        "resolutionAwareUnresolvedSegments": candidates.resolution_aware_unresolved_segments,
                    });
                    let frontier_state = serde_json::json!({
                        "enabled": frontier.enabled,
                        "planFailures": terrain.frontier_plan_failures,
                        "state": frontier.state.label(),
                        "exactGeneration": frontier.exact_generation,
                        "exactChunks": frontier.exact_chunks,
                        "preparationMicros": frontier.preparation_micros,
                        "presentationHash": frontier.presentation.semantic_hash,
                        "presentationLevels": frontier.presentation.level_count,
                        "exposedSegments": frontier.exposed_segments,
                        "solidSegments": frontier.solid_segments,
                        "waterSegments": frontier.water_segments,
                        "missingExactProfileSegments": frontier.missing_exact_profile_segments,
                        "worldBoundarySegments": frontier.world_boundary_segments,
                        "currentCertifiedSegments": frontier.current_certified_segments,
                        "currentUnclosedSegments": frontier.current_unclosed_segments,
                        "spacingOneConnectorSegments": frontier.spacing_one_connector_segments,
                        "unsupportedSpacingSegments": frontier.unsupported_spacing_segments,
                        "uncertifiedWaterSegments": frontier.uncertified_water_segments,
                        "missingProceduralSegments": frontier.missing_procedural_segments,
                        "ambiguousProceduralSegments": frontier.ambiguous_procedural_segments,
                        "maximumAdjacentSpacing": frontier.maximum_adjacent_spacing,
                        "adjacentSegmentsBySpacing": frontier.adjacent_segments_by_spacing,
                        "format": frontier_format,
                        "candidates": frontier_candidates,
                    });
                    let topology = terrain.frontier_topology;
                    let frontier_topology = serde_json::json!({
                        "planFailures": terrain.frontier_topology_failures,
                        "state": topology.state.label(),
                        "exactGeneration": topology.exact_generation,
                        "preparationMicros": topology.preparation_micros,
                        "presentationHash": topology.presentation.semantic_hash,
                        "presentationLevels": topology.presentation.level_count,
                        "exposedSegments": topology.exposed_segments,
                        "certifiedSegments": topology.certified_segments,
                        "unresolvedSegments": topology.unresolved_segments,
                        "preferredSolidSegments": topology.preferred_solid_segments,
                        "fallbackSolidSegments": topology.fallback_solid_segments,
                        "preferredWaterSegments": topology.preferred_water_segments,
                        "fallbackWaterSegments": topology.fallback_water_segments,
                        "worldBoundarySegments": topology.world_boundary_segments,
                        "unsupportedExactProfileSegments": topology.unsupported_exact_profile_segments,
                        "unsupportedProceduralSegments": topology.unsupported_procedural_segments,
                        "supportPoolCapacity": topology.support_pool_capacity,
                        "desiredFineTiles": topology.desired_fine_tiles,
                        "residentFineTiles": topology.resident_fine_tiles,
                        "selectedSupportTiles": topology.selected_support_tiles,
                        "rejectedSupportTiles": topology.rejected_support_tiles,
                        "baseSuppressionTiles": topology.base_suppression_tiles,
                        "outerStitchEdges": topology.outer_stitch_edges,
                        "outerStitchSegments": topology.outer_stitch_segments,
                        "supportPoolCapacityBytes": topology.support_pool_capacity_bytes,
                        "activeSupportResourceBytes": topology.active_support_resource_bytes,
                        "supportUniformUploadBytes": topology.support_uniform_upload_bytes,
                        "supportComputeDispatches": topology.support_compute_dispatches,
                        "supportTerrainVertices": topology.support_terrain_vertices,
                    ...
                    serde_json::json!({
                        ...
                        "exactBoundaryPreparationMicros": terrain.exact_boundary_preparation_micros,
                        "exactBoundaryColumns": terrain.exact_boundary_columns,
