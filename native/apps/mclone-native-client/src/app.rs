...
struct WindowFrameWorkSample {
    ...
    terrain_cull_ms: f64,
    terrain_cull_frustum_ms: f64,
    terrain_cull_traversal_ms: f64,
    terrain_cull_region_tests: usize,
    terrain_cull_region_rejections: usize,
    terrain_cull_section_tests: usize,
...
impl WindowFrameWorkSample {
    fn from_summary(summary: &MonoSceneFrameSummary) -> Self {
        ...
        Self {
            ...
            terrain_cull_frustum_ms: summary.render_timing.terrain_cull_frustum_ms,
            terrain_cull_traversal_ms: summary.render_timing.terrain_cull_traversal_ms,
            terrain_cull_region_tests: summary.render_timing.terrain_cull_region_tests,
            terrain_cull_region_rejections: summary.render_timing.terrain_cull_region_rejections,
            terrain_cull_section_tests: summary.render_timing.terrain_cull_section_tests,
    ...
    fn json(self) -> Value {
        json!({
            ...
            "render_timing": {
                ...
                "terrain_cull_frustum_ms": self.terrain_cull_frustum_ms,
                "terrain_cull_traversal_ms": self.terrain_cull_traversal_ms,
                "terrain_cull_region_tests": self.terrain_cull_region_tests,
                "terrain_cull_region_rejections": self.terrain_cull_region_rejections,
                "terrain_cull_section_tests": self.terrain_cull_section_tests,
