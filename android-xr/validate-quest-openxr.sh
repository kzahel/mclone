...
case "$XR_DEBUG_UI" in
    ""|none|pause|controls|graphics|seasonal|seasonal-debug|seasons|celestial|celestial-debug|sky)
        ;;
    *)
        mclone_die "unsupported --xr-debug-ui '$XR_DEBUG_UI'; expected none, pause, controls, graphics, seasonal-debug, or celestial-debug"
        ;;
esac
