  ...
  void verifiedSuite
    .then((suiteSha256) => {
      ...
      const response: ContinentalEcoregionWorkerSummary = {
        ...
        transitionPeerKind: compiler.transitionPeerKind(),
        transition: compiler.transition(),
        transitionWidthBlocks: compiler.transitionWidthBlocks(),
        ...
        leewardExposure: compiler.leewardExposure(),
        aridity: compiler.aridity(),
        drainagePermanence: compiler.drainagePermanence(),
        wetland: compiler.wetland(),
        corridor: compiler.corridor(),
        corridorKind: compiler.corridorKind(),
        ...
        corridorId: compiler.corridorId(),
...
function post(response: ContinentalEcoregionWorkerResponse): void {
  ...
  self.postMessage(response, {
    transfer: [
      ...
      response.transitionPeerKind.buffer,
      response.transition.buffer,
      response.transitionWidthBlocks.buffer,
