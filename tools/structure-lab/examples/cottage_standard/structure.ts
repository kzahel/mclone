...
export default structure({
  id: "farmstead-cottage-a-v2",
  label: "Warm Oak Cottage",
  description: "A steep-gabled plaster cottage with an offset canopy porch, flower box, and handmade chimney.",
  category: "building",
  size: [15, 15, sizeZ],
  family: {
    id: "farmstead-cottage",
    member: "standard-canopy-porch",
  ...
  components: [
    ...
    { id: "porch", label: "Canopy porch", optional: true },
  ...
  marker("attachment:west-yard", [1, 2, frontZ / 2 + 1]);
  socket("west-yard", "attachment:yard", [1, 2, frontZ / 2 + 1], "west");
});
