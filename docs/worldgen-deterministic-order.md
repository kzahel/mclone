...
The light solver's physical propagation footprint is a separate concern owned by [`lighting.md`](lighting.md). This section only states the generation-status gate for initial chunk light.
