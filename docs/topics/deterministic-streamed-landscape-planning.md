...
- [`../worldgen-deterministic-order.md`](../worldgen-deterministic-order.md)
  records the legacy Java 1.17.1 status and write-order model. This research
  may reuse its target-local start/reference pattern without making vanilla
  generation a product constraint.
