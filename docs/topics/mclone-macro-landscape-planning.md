...
| major rivers | warped zero-contour corridor with width/depth/bank morphology and receiving-outlet correction; detached continental candidate proved exact/LOD source sharing but not drainage | no accepted persistent macro drainage topology, tributary hierarchy, or named major reaches; Tactical 326 now owns one bounded directed catchment proof |
| streams | bounded 91-96-block valley-following source-to-river plan accepted as one local family | one peaceful family, not a general network; first continental tributary graph remains under Tactical 326 |
| ponds/lakes | river-adjacent wetland pools and shared local lake mechanism; detached candidate has flat water ownership | no accepted basin rim/spill/outlet plan; Human Review C rejected the candidate's thresholded uniform cliff-like lake rim |
