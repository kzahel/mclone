...
The checked JSON remains the current Rust runtime handoff. Player, chicken,
and cow regenerate byte-for-byte from their TypeScript sources. Upright bear
...
metadata normalized. `asset-lab:figures:check` covers all four promoted
...
vocabulary. All 202 canonical and 18 legacy Asset Lab examples pass a
...
The fourth post-migration content batch adds Giraffe, Rhinoceros, and
Hippopotamus as approved canonical box-only rigs. Giraffe is a 22-part
long-necked rig with patterned coat, mane, ears, and stepped ossicones;
Rhinoceros is a 25-part front-heavy rig with plated shoulders and two stepped
horns; and Hippopotamus is a 31-part low barrel rig with high-set eyes, tiny
ears, broad feet, and an oversized muzzle. All 78 parts are canonical boxes
and use eight combined pixel textures. Clean multi-angle sheets and
four-cycle walk videos were rendered under `/tmp/mclone-asset-lab/batch-4`,
...
The eighth post-migration content batch adds Raccoon, Red Squirrel, and River
Otter as approved canonical box-only rigs. Raccoon is an 18-part compact rig
with a broad face mask, dark paws, and a four-stage ringed tail; Red Squirrel
is an 18-part bound rig with deep haunches, tufted ears, and a three-stage
plume tail; and River Otter is a 17-part elongated swimmer with four webbed
paws and a two-stage lateral tail. All 53 parts are canonical boxes and use
nine combined pixel textures. Clean multi-angle sheets and four-cycle videos
were rendered under `/tmp/mclone-asset-lab/batch-8`, inspected for identity,
...
The tenth post-migration content batch adds Polar Bear, Cheetah, and Jaguar as
approved canonical box-only rigs. Polar Bear is an
18-part long-bodied adult with a narrow head, small ears, and oversized snow
paws; Cheetah is a 20-part narrow-waisted runner with tall legs, tear marks,
spots, and a paired-leg sprint; and Jaguar is a 23-part compact cat with heavy
shoulder and hip masses, broad cheeks, short legs, and rosette-patterned coat
faces. All 61 parts are canonical boxes and use 16 combined pixel textures.
Clean multi-angle sheets and four-cycle videos were rendered under
`/tmp/mclone-asset-lab/batch-10`, inspected for identity, grounding, attachment
...
The thirteenth post-migration content batch adds Red Panda, Meerkat, and
Hedgehog as approved canonical box-only rigs. Red Panda is a
21-part rust quadruped with a white facial mask and ruff, dark legs, and a
plush six-section ringed tail; Meerkat is a 19-part upright sentry with striped
torso, dark eye patches, folded forepaws, planted feet, balancing tail, and a
non-locomoting scanning cycle; and Hedgehog is a 19-part low quadruped with a
pointed cream face, tiny legs, and a four-step pixel-textured spine coat. All
59 parts are canonical boxes and use 10 combined pixel textures. Clean
multi-angle sheets and four-cycle videos were rendered under
`/tmp/mclone-asset-lab/batch-13` and inspected for
identity, grounding, attachment continuity, gait or sentry cadence, secondary
motion, and loop continuity, and approved by the user on 2026-07-20.

The fourteenth post-migration content batch adds Beaver, Capybara, and
Platypus as approved canonical box-only rigs. Beaver is a 19-part
deep-brown quadruped with a blunt muzzle, visible orange incisors, compact
legs, and a broad crosshatched two-stage paddle tail; Capybara is a 16-part
tailless barrel with a high blunt head, tiny ears, and short planted legs; and
Platypus is a 15-part low swimmer with a wide slate bill, four webbed feet, and
a two-stage paddle tail. All 50 parts are canonical boxes and use 12 combined
pixel textures. Clean multi-angle sheets and four-cycle videos were rendered
under `/tmp/mclone-asset-lab/batch-14` and inspected for identity, grounding or
...
The twenty-third post-migration content batch adds Pigeon, Robin, and Bee as
approved canonical box-only rigs. Pigeon is a 17-part steady flier with a
stocky slate body, iridescent neck, pale cere, barred broad wings, and
three-feather dark-banded tail; Robin is a 16-part quick flutter rig with an
olive-brown body, orange face and breast, short beak, fine wing bars, and paired
tail feathers; and Bee is a 17-part hover rig with a striped abdomen, fuzzy
thorax, large dark eyes, antennae, six tucked legs, stinger, and two paired
cell-patterned wings. All 50 parts are canonical boxes and use 12 combined
pixel textures across 24 textured parts and 45 explicit box-face applications.
Typechecking, the Asset Lab test suite, the first-party figure drift check, and
the repository diff check pass. Clean multi-angle sheets and four-cycle videos
were rendered under `/tmp/mclone-asset-lab/batch-23` and inspected for identity,
flight posture, attachment continuity, distinct flap cadence, paired-wing
motion, tail follow-through, and loop continuity. The batch was approved by the
user on 2026-07-21 after the pigeon's head/neck side-face coplanarity was
removed by narrowing its neck and the nearby neck/breast depth margin was
