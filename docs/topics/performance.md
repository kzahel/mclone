...
`11.037s` for `8464` RD10 target sections, so remaining splits are GPU
upload-only, then a persisted-world startup-streaming lane and Quest
persisted-world guardrail.
