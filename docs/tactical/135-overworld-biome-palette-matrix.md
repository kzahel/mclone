...
overworld tint IDs, and six supported feature-family probes landed
...
| 17 | `minecraft:desert_hills` | desert | sand/sandstone hills checked; cactus/dead-bush gap | seed `120`, chunk `(0,0)` | `[x] B [x] T [x] S [ ] F` |
...
| 130 | `minecraft:desert_lakes` | desert | desert surface checked; lake/fossil/cactus gap | seed `98`, chunk `(0,0)` | `[x] B [x] T [x] S [ ] F` |
...
1. Pick one missing block/feature family with high palette value and port it
   narrowly from Java: cactus/sugar cane, water plants plus coral/sea pickles,
   dark oak plus huge mushrooms, acacia, bamboo, jungle vines, or berry bushes.
