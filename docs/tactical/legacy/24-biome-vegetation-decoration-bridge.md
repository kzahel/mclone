...
Tactical 25 is now landed in [`25-biome-decoration-palette-expansion.md`](25-biome-decoration-palette-expansion.md): large ferns, berry bushes, mushrooms, pumpkins, sugar cane/cactus columns, and the supporting placers/decorators are now translated, the generated render palette can bake/render those blocks, and the browser smoke uses a naturally generated shoreline instead of a manual water patch. Tactical 26 should finish the real water-feature and broader biome-parity bridge with `LakeFeature`, `SpringFeature`, swamp surface mutation, and the remaining forest/plains/swamp tables.
