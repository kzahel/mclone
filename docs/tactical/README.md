...
| [`029-native-frame-pacing-and-streaming-hitches.md`](029-native-frame-pacing-and-streaming-hitches.md) | active | Native desktop frame pacing controls, live frame-budget diagnostics, and the follow-up plan for chunk publish, remesh, and upload hitches. |
