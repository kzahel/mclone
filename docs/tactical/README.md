...
| `ClientRuntime3-integrated-server-flow.md` | browser singleplayer `IntegratedServer` class/facade, local transport/session bootstrap, pause/resume/reset semantics | browser smoke + integration | **next** - make singleplayer visibly shaped like a client joining a local server |
