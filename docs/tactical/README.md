...
| `ClientRuntime1-client-world-replica-hydration.md` | first concrete `ClientWorld` facade over chunks, light, fluids, block entities, entities, revisions, and speculative overlays | unit + browser smoke | **next** - hydrate singleplayer and remote clients through the same client-world path |
