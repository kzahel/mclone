...
| [`RendererHost2-shared-frame-harness.md`](RendererHost2-shared-frame-harness.md) | shared static/generated frame harness with injectable scene/input | Deno WebGPU visual + browser probe | **next** — replace duplicated smoke orchestration with one harness that can drive browser canvas or headless texture targets |
