...
With the runtime arc accepted and tacticals 42 and 43 landed, the next highest-value worldgen/content slice should stay underground: finish the remaining active `BiomeDefaultFeatures` underground tail (glow lichen / rare dripstone) and soft-disk follow-through before returning to narrower surface parity cleanups.
