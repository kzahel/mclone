...
| [`RendererHost5-host-neutral-generated-world-runner.md`](RendererHost5-host-neutral-generated-world-runner.md) | shared generated-world scenario runner with host adapters for targets/assets/workers/artifacts | Deno WebGPU visual + browser probe | **next** — remove the remaining parallel frame orchestration between browser and Deno generated-world lanes |
