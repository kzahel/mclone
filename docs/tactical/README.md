...
| [`Creatures9-chicken-live-flap-egg-timer.md`](Creatures9-chicken-live-flap-egg-timer.md) | chicken flap/flap-speed/flapping state, egg timer decrement/reset, and chicken-jockey gate | unit | **baseline landed** - generated chickens now publish live flap and egg-timer data; egg item/sound side effects remain deferred |
| [`Creatures10-sheep-eat-block-goal.md`](Creatures10-sheep-eat-block-goal.md) | sheep `EatBlockGoal`, grass mutation, sheared-state reset, and eating head animation data | unit + runtime | **baseline landed** - generated sheep now eat grass through a shared world-mutation goal and publish authoritative eating animation data |
| [`Creatures11-passive-animal-breadth.md`](Creatures11-passive-animal-breadth.md) | mooshroom, rabbit, wolf baseline data/goals/models/renderers and starter island visibility | unit + runtime + visual | **baseline landed** - generated mooshrooms, rabbits, and wolves now publish, render, and share the passive movement/look stack |
| [`63-entity-residency-and-missing-collision-parity.md`](63-entity-residency-and-missing-collision-parity.md) | entity residency tickets, missing-collision source review, unload/tick parity gaps | runtime + source review | **graph slice landed** - level-derived holder status now propagates through a `ChunkTracker`-style fixed-point graph |
...
| [`RendererHost11-runtime-topology-descriptor.md`](RendererHost11-runtime-topology-descriptor.md) | generated-world runtime topology descriptor and boot-time validation | focused unit | **implemented** — browser and Deno boot adapters now declare topology, and smoke validation fails when scenario requirements and host carriers diverge |
