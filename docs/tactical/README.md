...
| [`63-entity-residency-and-missing-collision-parity.md`](63-entity-residency-and-missing-collision-parity.md) | entity residency tickets, missing-collision source review, unload/tick parity gaps | runtime + source review | **ticket-level slice landed** - generated holders now derive full status from numeric ticket levels before driving entity visibility/ticking |
