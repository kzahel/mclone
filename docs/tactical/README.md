...
| [`63-entity-residency-and-missing-collision-parity.md`](63-entity-residency-and-missing-collision-parity.md) | entity residency tickets, missing-collision source review, unload/tick parity gaps | runtime + source review | **source-ticket slice landed** - level-derived holder status now includes source-radius, light, and forced ticket sources |
