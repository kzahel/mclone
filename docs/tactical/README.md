...
| [`63-entity-residency-and-missing-collision-parity.md`](63-entity-residency-and-missing-collision-parity.md) | entity residency tickets, missing-collision source review, unload/tick parity gaps | runtime + source review | **holder status slice landed** - generated holders now own full-status transitions that drive entity visibility/ticking |
