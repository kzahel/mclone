...
| `13-` | `Block`, `BlockState`, property system (`Property`, `BlockStateDefinition`), `BlockGetter` stub | unit | prereqs model baking needs; `ResourceLocation` was pulled forward into `12` as a leaf dependency of the atlas port |
