...
| [`57-generated-chunk-holder-status-futures.md`](57-generated-chunk-holder-status-futures.md) | host-side `ChunkHolder`-style per-status futures and in-flight coalescing for generated chunks | runtime + perf | **partial** - preload plus terrain/features/no-light-full holder coalescing landed; recursive `ensureStatus(...)` is next |
