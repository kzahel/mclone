...
Current reuse/coalescing check:

- completed chunks and status records are reused while they remain inside the generated level authority window: job collection skips existing `LIQUID_CARVERS`, `FEATURES`, `FULL`, and already-published chunks, and each generation/decorate loop rechecks status immediately before doing work ([`generated-world-host.ts:585`](../../src/runtime/host/generated-world-host.ts), [`generated-world-host.ts:595`](../../src/runtime/host/generated-world-host.ts), [`generated-world-host.ts:618`](../../src/runtime/host/generated-world-host.ts), [`generated-world-host.ts:848`](../../src/runtime/host/generated-world-host.ts), [`generated-world-host.ts:876`](../../src/runtime/host/generated-world-host.ts))
- chunks outside the new authority window are removed from the in-memory `StaticRenderLevel` and their generated status records are deleted ([`generated-render-level.ts:168`](../../src/world/level/generated-render-level.ts), [`generated-render-level.ts:170`](../../src/world/level/generated-render-level.ts), [`generated-render-level.ts:171`](../../src/world/level/generated-render-level.ts), [`generated-render-level.ts:178`](../../src/world/level/generated-render-level.ts), [`generated-render-level.ts:190`](../../src/world/level/generated-render-level.ts))
- generated chunks are cached to durable storage only when a publishable snapshot is built; partial terrain/features status is not persisted separately ([`generated-world-host.ts:1435`](../../src/runtime/host/generated-world-host.ts), [`generated-world-host.ts:1436`](../../src/runtime/host/generated-world-host.ts), [`generated-world-host.ts:1446`](../../src/runtime/host/generated-world-host.ts), [`generated-world-host.ts:716`](../../src/runtime/host/generated-world-host.ts), [`generated-world-host.ts:721`](../../src/runtime/host/generated-world-host.ts))
- cooperative scheduling cancels by view revision at phase boundaries, but there is no per-chunk/status in-flight future table. Superseded jobs can finish the current chunk/status quantum before observing cancellation; same-view repeated requests can schedule another job, though status guards usually collapse duplicate completed work ([`generated-world-host.ts:571`](../../src/runtime/host/generated-world-host.ts), [`generated-world-host.ts:578`](../../src/runtime/host/generated-world-host.ts), [`generated-world-host.ts:807`](../../src/runtime/host/generated-world-host.ts), [`generated-world-host.ts:844`](../../src/runtime/host/generated-world-host.ts), [`generated-world-host.ts:872`](../../src/runtime/host/generated-world-host.ts))
