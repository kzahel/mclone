...
- Also still deferred at the time: sunflower-plains specific `PATCH_SUNFLOWER`, vine placement consumers, and bee-decorator variants. The bee-decorator follow-through later landed in [`51-bee-tree-decorator-follow-through.md`](51-bee-tree-decorator-follow-through.md), and the sunflower patch follow-through later landed in [`52-sunflower-plains-follow-through.md`](52-sunflower-plains-follow-through.md); vine placement consumers are the next simple decoration gap in this family.
