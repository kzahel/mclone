...
| [`019-scheduler-owned-dependency-holders.md`](019-scheduler-owned-dependency-holders.md) | active | Propagated ticket levels, scheduler-owned lower-status dependency holders, client visibility split, and dependency reuse metrics. |
