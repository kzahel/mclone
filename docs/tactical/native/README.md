...
| [`025-render-section-visibility-graph.md`](025-render-section-visibility-graph.md) | first pass landed | Java `VisGraph` / `VisibilitySet` parity, oracle fixtures, conservative section occlusion traversal, and culling instrumentation. |
