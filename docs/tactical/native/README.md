...
| [`018-chunk-ticket-distance-manager.md`](018-chunk-ticket-distance-manager.md) | active | Java-shaped ticket levels, forced/stale tickets, holder full-status facts, and ticket-driven load/unload reconciliation. |
