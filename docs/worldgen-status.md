...
| Tree pipeline | `85-92%` | Oak / swamp oak / fancy oak / spruce / pine / mega pine / mega spruce / birch / dark oak / acacia / jungle / mega-jungle / bamboo-jungle / huge-mushroom paths exist, bee-decorated oak/birch/fancy-oak variants are now wired through the live flower-forest, birch, and plains selectors, and swamp-oak leaf vines now match vanilla again; remaining gaps are narrower decorator/table exactness | [`23`](./tactical/23-true-tree-feature-placement.md), [`24`](./tactical/24-biome-vegetation-decoration-bridge.md), [`27`](./tactical/27-biome-decoration-parity-follow-through.md), [`33`](./tactical/33-dark-forest-parity.md), [`34`](./tactical/34-savanna-parity.md), [`35`](./tactical/35-jungle-parity.md), [`36`](./tactical/36-snowy-giant-taiga-and-mushroom-table-coverage.md), [`41`](./tactical/41-bamboo-jungle-parity.md), [`51`](./tactical/51-bee-tree-decorator-follow-through.md), [`53`](./tactical/53-swamp-oak-vine-follow-through.md) |
...
The current vegetation set is already enough to make scenes legible, and the bee, sunflower, and swamp-oak vine follow-through removed the clearest remaining explicit table omissions. The next leverage point is the remaining visible exactness work that is still narrow enough to validate directly:

- exact `deep_warm_ocean` `SEAGRASS_SIMPLE` / `CARVING_MASK` follow-through
- remaining biome-specific decorators and selector exactness
