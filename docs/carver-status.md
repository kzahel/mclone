...
4. For broader overworld recognizability, classic carvers no longer need to stay above the next biome-identity slice; jungle parity is now the highest-value follow-through outside the narrower exhaustive-parity work.
