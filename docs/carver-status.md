...
4. For broader overworld recognizability, classic carvers no longer need to stay above the next biome-table slice; with jungle core parity landed, the next broad follow-through is snowy / giant-tree-taiga / mushroom-field table coverage outside the narrower exhaustive-parity work.
