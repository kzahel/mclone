...
import {
  ...
  DEFAULT_PIG_TEXTURE,
  DEFAULT_RABBIT_BLACK_TEXTURE,
  DEFAULT_RABBIT_BROWN_TEXTURE,
  DEFAULT_RABBIT_EVIL_TEXTURE,
  DEFAULT_RABBIT_GOLD_TEXTURE,
  DEFAULT_RABBIT_SALT_TEXTURE,
  DEFAULT_RABBIT_TOAST_TEXTURE,
  DEFAULT_RABBIT_WHITE_TEXTURE,
  DEFAULT_RABBIT_WHITE_SPLOTCHED_TEXTURE,
