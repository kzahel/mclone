...
const SMALL_ISLAND_STARTER_MOBS = [
  ...
  { type: EntityTypes.MOOSHROOM, slug: "mooshroom", x: 1.5, z: 1.5, yaw: 35.0 },
  { type: EntityTypes.MOOSHROOM, slug: "mooshroom", x: 14.5, z: 14.5, yaw: 215.0 },
  ...
  { type: EntityTypes.RABBIT, slug: "rabbit", x: 1.5, z: 4.5, yaw: 55.0 },
  { type: EntityTypes.RABBIT, slug: "rabbit", x: 4.5, z: 1.5, yaw: 145.0 },
  { type: EntityTypes.RABBIT, slug: "rabbit", x: 12.5, z: 1.5, yaw: 235.0 },
  { type: EntityTypes.RABBIT, slug: "rabbit", x: 1.5, z: 14.5, yaw: 325.0 },
  { type: EntityTypes.SHEEP, slug: "sheep", x: 5.5, z: 3.5, yaw: 15.0 },
  ...
  { type: EntityTypes.WOLF, slug: "wolf", x: 14.5, z: 1.5, yaw: 70.0 },
  { type: EntityTypes.WOLF, slug: "wolf", x: 1.5, z: 7.5, yaw: 250.0 },
