...
import { UnderwaterCanyonWorldCarver } from "./underwater-canyon-world-carver.ts";
...
export const UNDERWATER_CANYON = configureWorldCarver(new UnderwaterCanyonWorldCarver(), {
  probability: 0.02,
  y: biasedToBottomHeight(absolute(20), absolute(67), 8),
  yScale: constantFloat(3.0),
  lavaLevel: aboveBottom(10),
...
export const UNDERWATER_CAVE = configureWorldCarver(new UnderwaterCaveWorldCarver(), {
  probability: 0.06666667,
  y: biasedToBottomHeight(absolute(0), absolute(127), 8),
  yScale: constantFloat(0.5),
  lavaLevel: aboveBottom(10),
...
export const OCEAN_OVERWORLD_LIQUID_CARVERS = [UNDERWATER_CANYON, UNDERWATER_CAVE] as const;
